...
const defensifAxaCardif: Profile = {
  ...
  inventory: [
    { name: 'MS INVF Global Brands A', isin: 'LU0133620416', sri: 4, fees: 1.84, perfSinceJan: -2.52, quotePart: 5.88, category: 'Actions Intl Gdes Cap. Mixte', reporting: true },
    { name: 'R-co Valor F EUR', isin: 'FR0018507737', sri: 4, fees: 1.93, perfSinceJan: 0.49, quotePart: 7.64, category: 'Allocation EUR Flexible', reporting: true },
    { name: 'Eurose C', isin: 'FR0010731044', sri: 3, fees: 1.41, perfSinceJan: 3.83, quotePart: 6.84, category: 'Allocation EUR Prudente', reporting: true },
    { name: 'Carmignac PF Emerg Patrim A', isin: 'LU0336084032', sri: 3, fees: 1.81, perfSinceJan: 0.27, quotePart: 8.14, category: 'Actions Marchés Émergents', reporting: false },
    { name: 'Moyenne Fonds Euro', isin: 'META00000001', sri: 1, fees: 0.0, perfSinceJan: 0.73, quotePart: 39.37, category: 'Autres', reporting: false },
    { name: 'DNCA Invest Convertibles Y EUR', isin: 'LU0743711678', sri: 3, fees: 2.69, perfSinceJan: 5.66, quotePart: 8.15, category: 'Convertibles International', reporting: true },
    { name: 'Sofidy Sélection 1 P', isin: 'FR0011694765', sri: 4, fees: 2.3, perfSinceJan: -2.3, quotePart: 4.84, category: 'Immobilier — Indirect Zone Euro', reporting: false },
    { name: 'Carmignac PF Credit A EUR', isin: 'LU0992163643', sri: 3, fees: 1.1, perfSinceJan: 2.1, quotePart: 8.8, category: 'Obligations EUR Flexibles', reporting: true },
    { name: 'R-co Conviction Credit Euro F', isin: 'FR0010498077', sri: 3, fees: 0.95, perfSinceJan: 1.4, quotePart: 6.34, category: 'Obligations EUR Emprunts Privés', reporting: false },
  ],
  vpInventory: [
